...
namespace Homebrew
{
    ...
    private void Awake()
		{
      var uiTex_in = Resources.Load<Texture2D>("InspectorFoldoutGroup/IN foldout focus-6510");
			var uiTex_in_on = Resources.Load<Texture2D>("InspectorFoldoutGroup/IN foldout focus on-5718");
			...
			try
			{
				if (EditorStyles.foldout == null) { return; }
			}
    ...
    protected void OnEnable()
		{
			...
			var fields = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance;
			objectFields = target.GetType().GetFields(fields)
